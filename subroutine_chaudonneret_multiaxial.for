	MODULE STATEMODULE
	REAL PCYC, ISJUMP, MAXDDOT
	DIMENSION DDOTARR(37524)
	COMMON /STATEINFO/ DDOTARR, PCYC, ISJUMP, MAXDDOT
	SAVE
	END MODULE
	  ...
	  WRITE(6,*) KSTEP, KINC, LOP, PCYC, ISJUMP, MAXDDOT
     ...
     3 MACAULAY, ALPHA, DDOT, DN, DDMG
	  ...
	  IF (ISJUMP.EQ.1) THEN
		...
		IF ((DMG+DDMG).LE.1) THEN
		  ...
		  NCYC = NCYC+DN
		ENDIF
		!WRITE(6,*) NOEL, 'IN JUMP'
      ENDIF
	  !WRITE(6,*) NOEL, 'OUTSIDE JUMP'
